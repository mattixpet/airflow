...
=========================================== ===================== ===================================================================
``{{ data_interval_start }}``               `pendulum.DateTime`_  Start of the data interval. See `Data Interval <https://airflow.apache.org/docs/apache-airflow/stable/core-concepts/dag-run.html#data-interval>`_. Added in version 2.3.
``{{ data_interval_end }}``                 `pendulum.DateTime`_  End of the data interval. See `Data Interval <https://airflow.apache.org/docs/apache-airflow/stable/core-concepts/dag-run.html#data-interval>`_. Added in version 2.3.
